            ...
            <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                        @forelse($supports->items() as $support)
                            <tr>
                                ...
                                <td class="px-12 py-2 text-sm font-medium whitespace-nowrap">
                                    <div class="inline px-3 py-1 text-sm font-normal rounded-full text-black-500 gap-x-2 bg-green-100/60">
                        ...
                        @empty
                            <tr>
                                <td class="px-4 py-2 text-sm font-medium whitespace-nowrap dark:text-white text-center" colspan="5">
                                    Não possui nenhuma dúvida.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
